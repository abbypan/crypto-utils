...
// AES-256-ctr with libcrypto
// gcc -Wall -lcrypto -o aes256ctr-decrypt aes256ctr-decrypt.c
...
// cat ciphertext | ./aes256ctr-decrypt $KEY $IV
...
int main(int ac, char **av, char **ae)
{
  ...
  if (!(cipher = EVP_aes_256_ctr())) handleCryptoError();
...
//int nbytes = input + input_len - 16 - current;
    int nbytes = input + input_len  - current;
